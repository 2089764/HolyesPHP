<?php 
	class Debug {
		 ...
		 * @param	int	$type	消息的类型  0 错误说明  1   自动包含类  2  sql语句展示
		 */
		...
		static function message(){
			...
			if(count(self::$errorFiles) > 0) {
				echo '<br>［追踪异常］';
				foreach(self::$errorFiles as $errorFile){
					echo '<li style="color:red;">&nbsp;&nbsp;&nbsp;&nbsp;'.$errorFile.'</li>';
				}
			}
            echo '</ul></div>';
